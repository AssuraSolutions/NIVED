      ...
      <div className="container mx-auto px-4 pt-4 md:pt-10">
        ...
        <section className="relative py-10 md:py-10">
          <div className="grid gap-8 md:grid-cols-2 items-center">
            <div
              className="relative h-[700px] md:h-[600px] md:w-[500px]  sm:h-[100px] overflow-hidden 
              border-2 border-[#c9a55c] text-[#c9a55c] hover:bg-[#c9a55c]/10 
              rounded-[255px_15px_225px_15px/15px_225px_15px_255px] transition-all"
            >
              <Image
            ...
            <div className="space-y-6 text-center md:text-left">
              ...
              <p className="text-lg text-gray-700 max-w-md md:max-w-md w-full mx-auto md:mx-0">
