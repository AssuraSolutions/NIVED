...
export async function PUT(request: Request, { params }: { params: { id: string } }) {
  try {
    ...
    if (body.clothingTypeId !== undefined) updateData.clothingTypeId = Number(body.clothingTypeId)
    if (body.images !== undefined) updateData.images = Array.isArray(body.images) ? body.images : []
    if (body.availableSizes !== undefined) updateData.availableSizes = Array.isArray(body.availableSizes) ? body.availableSizes : []
