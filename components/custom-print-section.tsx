    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-playfair text-3xl md:text-4xl font-bold text-gray-900 mb-6">Custom T-shirt Printing</h2>
            <p className="text-gray-700 mb-8 text-lg">
              Bring your ideas to life with our custom printing service. Designed and manufactured in Ceylon with care
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Upload your artwork or work with our designers</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="bg-[#c9a55c]/10 p-2 rounded-full">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Premium fabrics that feel great and last long</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="bg-[#c9a55c]/10 p-2 rounded-full">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Fast production and delivery options available</p>
                </div>
              </div>
            </div>
            <Button
          ...
          <div className="relative h-[400px] md:h-[500px] rounded-[255px_15px_225px_15px/15px_225px_15px_255px] overflow-hidden border-4 border-white shadow-xl">
            <Image
